...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("¡Genial, has ganado!");
      // this is messy
      this.msgText.html("Resolviste la palabra en<span class='highlight'>" + rating.guesses + "</span> intentos!<br>Score: <span class='highlight'>" + rating.rating + "%</span>");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("Pierdes.. LA palabra era <span class='highlight'>"+ this.wrd.word +"</span>");
      this.msgText.html("No te preocupes, ¡Adivinarás la próxima!");
      this.showMsg();
